...
export default function MilestoneAnimation({ progress, theme = 'tree', showLabel = true }: Props) {
  ...
  return (
    <View style={styles.container}>
      <Animated.View
        style={[styles.sceneFrame, { height: sceneHeight, transform: [{ scale: pulse }] }]}
      >
      ...
      {showLabel && (
        <View style={styles.labelContainer}>
          ...
          {theme === 'house' && (
            <Text style={styles.houseStepText}>
