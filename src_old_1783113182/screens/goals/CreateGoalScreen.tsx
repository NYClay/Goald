...
export default function CreateGoalScreen() {
  ...
  const fieldErrors = {
    ...
    targetAmount: submitAttempted && target <= 0 ? 'Enter a target amount greater than zero.' : '',
    monthlyContribution:
      submitAttempted && monthly <= 0 ? 'Enter a monthly contribution greater than zero.' : '',
  };
  ...
  async function handleCreate() {
    ...
    const currentFieldErrors = {
      ...
      monthlyContribution: monthly <= 0 ? 'Enter a monthly contribution greater than zero.' : '',
    };
      ...
      >
        ...
        {target > 0 ? (
          ...
          <Text style={styles.exampleText}>
            Example only, not pre-filled: {formatCurrency(10000)}
          </Text>
        )}
        ...
        {monthly > 0 ? (
          ...
          <Text style={styles.exampleText}>
            Example only, not pre-filled: {formatCurrency(500)} / month
          </Text>
        )}
        ...
        {estimatedMonths !== null && isFinite(estimatedMonths) && (
          <View style={styles.projection}>
            <Text style={styles.projectionText}>
              📈 Estimated completion: {estimatedMonths} months ({(estimatedMonths / 12).toFixed(1)}{' '}
              years)
            </Text>
          </View>
        )}
